...
Possibly filtered by a prefix and a delimiter. See [https://cloud.google.com/storage/docs/json\_api/v1/objects/list](https://cloud.google.com/storage/docs/json\_api/v1/objects/list)
...
Possibly filtered by a prefix and a delimiter. See [https://cloud.google.com/storage/docs/json\_api/v1/objects/list](https://cloud.google.com/storage/docs/json\_api/v1/objects/list). The next page token can be used to retrieve more pages, maxPageResults to manage page size and pages to specify how many pages to load.
